...
export function buildMethodsText(ctx: MethodsContext): string {
  ...
  return [
    ...
    `Analysis was performed with Marine Omics Pathway Explorer v${APP_VERSION}. Pathway sources: WikiPathways (https://www.wikipathways.org) and Reactome (https://reactome.org); please cite these resources.`,
  ].join(' ');
}
